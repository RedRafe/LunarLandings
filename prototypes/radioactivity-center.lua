...
data_util.allow_productivity('ll-alien-artifact')
data_util.allow_productivity('ll-luna-sample')
data_util.allow_productivity('ll-empty-frame')
data_util.allow_productivity('ll-empty-frame-casting')
data_util.allow_productivity('ll-capsule')

data_util.whitelist_recipes('ll-alien', {
  'll-alien',
