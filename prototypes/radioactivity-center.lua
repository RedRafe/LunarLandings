...
x_util.allow_productivity('ll-alien-artifact')
x_util.allow_productivity('ll-luna-sample')
x_util.allow_productivity('ll-empty-frame')
x_util.allow_productivity('ll-empty-frame-casting')
x_util.allow_productivity('ll-capsule')

x_util.whitelist_recipes('ll-alien', {
  'll-alien',
