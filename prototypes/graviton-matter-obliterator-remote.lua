...
data:extend({
  ...
  -- Item
  {
    ...
    icons = {
      {
        icon = '__LunarLandings__/graphics/icons/artillery-bombardment-remote.png',
        icon_size = 32
      },
    },
    flags = {'mod-openable'},
  ...
  -- Item
  {
    ...
    icons = {
      {
        icon = '__LunarLandings__/graphics/icons/artillery-smart-remote.png',
        icon_size = 32
      }
    },
    flags = {'mod-openable'},
  ...
  -- Item
  {
    ...
    icons = {
      {
        icon = '__LunarLandings__/graphics/icons/artillery-exploration-remote.png',
        icon_size = 32
      }
    },
    flags = {},
